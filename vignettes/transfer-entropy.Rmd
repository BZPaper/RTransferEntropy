...
Furthermore, this package gives the users more flexibility in specifying details of the computation including calculating R\'{e}nyi's transfer entropy, specifying different lags for x and y, different quantiles of the empirical distribution, or the number of bins.
