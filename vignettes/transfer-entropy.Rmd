...
We visualize the relationship between the different lag-structures of $X$ and $Y$ in the following scatterplot.
The left-hand-side shows the relations for lagged $X$, thus looking at $X \rightarrow Y$.
The plot in the centre displays the level-level relationship between the two variables (no lags are used).
The right-hand-side shows the relations for lagged $Y$, thus the effect of $Y \rightarrow X$.
