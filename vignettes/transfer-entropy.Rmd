...
Regarding the above example, where the results show a significant information flow from $X$ to $Y$, but not vice versa.
...
As in the above example, a scatterplot provides a first approximation of the dependencies among both time series for different lead-lag combinations.
