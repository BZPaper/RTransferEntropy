...
The following scatterplots provide a first illustration of the dependencies among both time series.
...
As in the above example, a scatterplot provides a first illustration of  the dependencies among both time series for different lead-lag combinations.
