...
The left-hand-side shows the relations for lagged $X$, the plot in the centre displays the level-level relationship between the two variables (no lags are used) and the right-hand-side shows the relations for lagged $Y$.
