...
Also, as can easily be seen from the confidence bounds, the information flow towards the market is not statistically significant in two cases (on a 5\% significance level).  
