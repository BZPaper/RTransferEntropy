...
#' y. Both time series x and y are assumed to have been generated by Markov 
#' processes of order k and j, respectively. Thus, the information flow from y 
#' to x is measured. Change x and y in function call to infer the dominant 
